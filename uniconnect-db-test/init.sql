...
CREATE TABLESPACE ts_db_project OWNER uniconnect_admin LOCATION '/var/lib/postgresql/data/ts_db_project';

-- Create the database with the specified tablespace
